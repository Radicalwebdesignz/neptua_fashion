...
<section class="slider">
    <div class="container-fluid">
        <div class="row slider">
            ...
            <div class="slider--body">
                <img src="assets/images/home_slider2.jpg" class="img img-fluid">
                <div class="slider--text">
                	<h2>Neptua Fashion</h2>
	...
	<div class="container py-5">
		<div class="row text-center text-white">
			<div class="col-md-12">
				...
				<p class="pt-3">Donec faucibus consequat ante. Mauris eget mi sed ex efficitur porta id non quam. Cras aliquam turpis tellus, quis laoreet lacus congue sed. Nullam at est quis urna vestibulum interdum. Praesent auctor leo ut massa ultrices tempor.</p>
			</div>
		</div>
	</div>
</section>
...
<section class="signup">
	<div class="container text-center">
		<div class="row text-white">
			<div class="col-md-8 signup--content">
				<h3>Live From The Eco Studio! Get Your Tickets Today!</h3>
			</div>
...
<section class="collections">
	<div class="container-fluid p-0 py-5 text-center">
...
<section class="news-testimonials">
	<div class="container-fluid py-5 px-0">
		<div class="row text-white no-gutters">
			<div class="col-md-6 text-center">
				...
				<div class="row py-5 px-5">
					...
					<div class="col-lg-9 col-md-12 news-testimonials--centered news-testimonials--padding">
						...
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Perspiciatis, et suscipit vero fugiat eligendi facere sed nobis quae eum laborum!</p>
						<div>
		            		<button class="btn btn-outline-light">Read More</button>
		            	</div>
					</div>
			...
			<div class="col-md-6 news-testimonials--reviews px-5 pt-5">
				<h3 class="text-center">Testimonials</h3>
				<p class="text-center">CLIENTS LOVE US</p>
				<div class="slider">
					<div class="text-center">
						<img src="assets/images/testimonial1.jpg" class="pt-2 pb-4 img img-fluid mx-auto rounded-circle">
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Laboriosam ad, repudiandae nam cum dicta nisi fugiat voluptas, porro iure at atque labore nobis aliquam quod molestias debitis possimus maiores veritatis</p>
						<p><strong>Angelina, Fashion Magazine</strong></p>
					</div>
					<div class="text-center">
						<img src="assets/images/testimonial2.jpg" class="pt-2 pb-4 img img-fluid mx-auto rounded-circle">
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Laboriosam ad, repudiandae nam cum dicta nisi fugiat voluptas, porro iure at atque labore nobis aliquam quod molestias debitis possimus maiores veritatis</p>
						<p><strong>Brad, Fashion Designer</strong></p>
					</div>
				</div>
			</div>
		</div>
