	...
	<div class="container banner-section text-white text-center">
		...
		<div class="row">
			<div class="col-md-4 text-center">
				...
				<h2 class="d-inline count">350</h2>
				<p class="py-3">Completed Fashion Shows</p>
			</div>
			<div class="col-md-4 text-center">
				<i class="far fa-heart icon-font">&nbsp;</i>
				<h2 class="d-inline count">1265</h2>
				<p class="py-3">Beautifully Happy Clients</p>
			</div>
			<div class="col-md-4 text-center">
				<i class="fas fa-leaf icon-font">&nbsp;</i>
				<h2 class="d-inline count">456</h2>
				<p class="py-3">All Natural Fabrics</p>
			</div>
		</div>
	</div>
</section>
...
<section class="testimonial-slider">
    <div class="container text-center">
        <div class="row">
        	<div class="col-md-12 py-5 text-white slider">
	        	<div>
	        		<h1>Testimonials</h1>
		        	<p class="pb-4">CLIENTS LOVE US</p>
		        	<div class="text-center">
		        		<img src="assets/images/testimonial1.jpg" class="img img-fluid rounded-circle">	
		        	</div>
					<p class="py-3"><i>Praesent ut sem dignissim, dapibus est et, consectetur sem. Integer scelerisque hendrerit placerat. Nullam imperdiet lectus at elit fringilla, vitae ullamcorper leo luctus. Duis imperdiet ut ex et ullamcorper. Duis lorem turpis, scelerisque sit.</i></p>
					<h4>ANGELINA, Fashio Designer</h4>
	        	</div>
	        	<div>
	        		<h1>Testimonials</h1>
	        		<p class="pb-4">CLIENTS LOVE US</p>
		        	<div class="text-center">
		        		<img src="assets/images/testimonial2.jpg" class="img img-fluid rounded-circle">	
		        	</div>
					<p class="py-3"><i>Praesent ut sem dignissim, dapibus est et, consectetur sem. Integer scelerisque hendrerit placerat. Nullam imperdiet lectus at elit fringilla, vitae ullamcorper leo luctus. Duis imperdiet ut ex et ullamcorper. Duis lorem turpis, scelerisque sit.</i></p>
					<h4>MATT, Fashio Icon</h4>
	        	</div>
            </div>
        </div>
    </div>
