...
<section class="quote banner-centered-text" data-type="background" data-speed="5">
	<div class="container banner-section">
		<div class="row">
			<div class="col-md-12 text-center text-white">
				<h3><i class="fas fa-quote-left fa-2x icon-color"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i>Fashion is about something that comes from within you</i></h3>
				<p>– RALPH LAUREN</p>
			</div>
		</div>
	</div>
	...
	<div class="container py-5">
		<div class="row">
			<div class="col-md-12 text-center text-white">
				<h3>The Values</h3>
				<img src="assets/images/hr.png" class="img img-fluid py-4">
				<p>Morbi sollicitudin odio at lorem euismod tincidunt. Cras purus justo, scUt at sapien vel sem commodo faucibus. Morbi ut lorem ligula. Vivamus sodales nunc aliquam aliquam. Fusce dapibus commodo aet</p>
			</div>
		</div>
	</div>
			...
			<div class="row pb-5">
					...
					<div class="flip-container" ontouchstart="this.classList.toggle('hover');">
					  	<div class="flipper">
						    ...
						    <div class="back text-dark">
							    ...
							    <div class="back-title">Elegance</div>
							    <p>Ut at sapien vel sem commodo faucibus. Morbi ut lorem ligula. Vivamus sodales nunc aliquam aliquam. Fusce dapibus commodo aet</p>
						    </div>
					  	</div>
					</div>
				</div>
				<div class="col-lg-4 col-md-6 mt-4">
					<div class="flip-container" ontouchstart="this.classList.toggle('hover');">
					  	<div class="flipper">
						    ...
						    <div class="back text-dark">
							    <div class="back-logo"></div>
							    <div class="back-title">Flexible</div>
							    <p>Ut at sapien vel sem commodo faucibus. Morbi ut lorem ligula. Vivamus sodales nunc aliquam aliquam. Fusce dapibus commodo aet</p>
						    </div>
					  	</div>
					</div>
				...
				<div class="col-lg-4 col-md-6 mt-4">
					<div class="flip-container" ontouchstart="this.classList.toggle('hover');">
					  	<div class="flipper">
						    ...
						    <div class="back text-dark">
							    <div class="back-logo"></div>
							    <div class="back-title">Unity</div>
							    <p>Ut at sapien vel sem commodo faucibus. Morbi ut lorem ligula. Vivamus sodales nunc aliquam aliquam. Fusce dapibus commodo aet</p>
						    </div>
					  	</div>
					</div>
				...
				<div class="col-lg-4 col-md-6 mt-4">
					<div class="flip-container" ontouchstart="this.classList.toggle('hover');">
					  	<div class="flipper">
						    ...
						    <div class="back text-dark">
							    <div class="back-logo"></div>
							    <div class="back-title">Access</div>
							    <p>Ut at sapien vel sem commodo faucibus. Morbi ut lorem ligula. Vivamus sodales nunc aliquam aliquam. Fusce dapibus commodo aet</p>
						    </div>
					  	</div>
					</div>
				...
				<div class="col-lg-4 col-md-6 mt-4">
					<div class="flip-container" ontouchstart="this.classList.toggle('hover');">
					  	<div class="flipper">
						    <div class="front">
						      <span class="name">Diversity</span>
						    </div>
						    <div class="back text-dark">
							    <div class="back-logo"></div>
							    <div class="back-title">Diversity</div>
							    <p>Ut at sapien vel sem commodo faucibus. Morbi ut lorem ligula. Vivamus sodales nunc aliquam aliquam. Fusce dapibus commodo aet</p>
						    </div>
					  	</div>
					</div>
				...
				<div class="col-lg-4 col-md-6 mt-4">
					<div class="flip-container" ontouchstart="this.classList.toggle('hover');">
					  	<div class="flipper">
						    ...
						    <div class="back text-dark">
							    <div class="back-logo"></div>
							    <div class="back-title">Creative</div>
							    <p>Ut at sapien vel sem commodo faucibus. Morbi ut lorem ligula. Vivamus sodales nunc aliquam aliquam. Fusce dapibus commodo aet</p>
						    </div>
					  	</div>
					</div>
	...
	<div class="container py-5">
		<div class="row text-white">
			...
			<div class="row pb-5 reveal-item waypoint">
				...
				<div class="col-md-3 text-center pt-5 col-sm-6">
					<img src="assets/images/client2.png" class="img img-fluid">
				</div>
				<div class="col-md-3 text-center pt-5 col-sm-6">
					<img src="assets/images/client3.png" class="img img-fluid">
				</div>
				<div class="col-md-3 text-center pt-5 col-sm-6">
					<img src="assets/images/client4.png" class="img img-fluid">
				</div>
				<div class="col-md-3 text-center pt-5 col-sm-6">
					<img src="assets/images/client5.png" class="img img-fluid">
				</div>
				<div class="col-md-3 text-center pt-5 col-sm-6">
					<img src="assets/images/client6.png" class="img img-fluid">
				</div>
				<div class="col-md-3 text-center pt-5 col-sm-6">
					<img src="assets/images/client7.png" class="img img-fluid">
				</div>
				<div class="col-md-3 text-center pt-5 col-sm-6">
					<img src="assets/images/client8.png" class="img img-fluid">
				</div>
			</div>	
		</div>
	</div>
